...
features (`app/js/tour.js`): two Guadix sample laps (`app/demo/`, drivers anonymised, each with its complete lap video at
640 px, about 4 MB per clip, fetched only when the tour starts)

...
export async function nativeBuildRnz(input, dataFile) {
  ...
  let x = `<?xml version="1.0" encoding="UTF-8"?>\n<lapData xmlns="http://macrix.eu/racenavigator/LapDataSchema" exportDeviceName="RN Analyzer 2.0 (iOS)" exportDeviceVersion="2.0.0" exportDeviceTime="${now}" exportDataVersion="5" lastExportRnDeviceName="${esc(b.dev)}" sourceDeviceName="${esc(txt(L, 'deviceName') || b.dev)}">\n`;

...
const dict = {
  en: {
    ...
    tour_device: 'Race Navigator: the RN Analyzer app from the App Store or Google Play connects to the device in its WiFi, controls recording, driver and car, imports laps with their videos – and adds your heart rate from Apple Health or Health Connect as a channel.',
  ...
  de: {
    ...
    tour_device: 'Race Navigator: Die RN Analyzer App aus dem App Store oder von Google Play verbindet sich mit dem Gerät im WLAN, steuert Aufnahme, Fahrer und Fahrzeug, importiert Runden samt Videos – und ergänzt den Puls aus Apple Health oder Health Connect als Kanal.',

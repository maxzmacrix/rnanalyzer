...
const dict = {
  en: {
    ...
    tour_chart: 'Charts compare channels over distance or time. Tap the title to change the channel, pinch to zoom, drag to move the cursor.',
    ...
    tour_device: 'Race Navigator: connect to the device in its WiFi, control recording, driver and car, and import laps with their videos directly.',
  ...
  de: {
    ...
    tour_chart: 'Diagramme vergleichen Kanäle über Distanz oder Zeit. Titel antippen wechselt den Kanal, Zwei-Finger-Zoom, Ziehen bewegt den Cursor.',
    ...
    tour_device: 'Race Navigator: Gerät im eigenen WLAN verbinden, Aufnahme, Fahrer und Fahrzeug steuern und Runden samt Videos direkt importieren.',

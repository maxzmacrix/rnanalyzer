...
const dict = {
  en: {
    ...
    control_no_device: 'No Race Navigator connected', control_no_device_hint: 'Connect to your device in the Devices tab first.',
  ...
  de: {
    ...
    control_no_device: 'Kein Race Navigator verbunden', control_no_device_hint: 'Verbinde Dich zuerst im Tab Geräte mit Deinem Gerät.',

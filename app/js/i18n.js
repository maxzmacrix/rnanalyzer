...
const dict = {
  en: {
    ...
    suggest_done: '{n} laps: fastest, best sectors, typical',
    ...
    tour_suggest: '“Suggest comparison” picks the fastest lap, the laps with a best sector and a typical lap and opens the comparison.',
    tour_play: 'Play runs the laps together. The numbers show how much time each lap loses against the fastest one, right now.',
    tour_chart: 'The gap curve shows where time is lost: rising means losing. Tap the title to see speed, braking or cornering instead.',
    tour_map: 'On the map the fastest lap is painted red where the other lap loses and green where it gains.',
  ...
  de: {
    ...
    suggest_done: '{n} Runden: schnellste, beste Sektoren, typische',
    ...
    tour_suggest: '„Vergleich vorschlagen“ wählt die schnellste Runde, die Runden mit einem besten Sektor und eine typische Runde und öffnet den Vergleich.',
    ...
    tour_chart: 'Die Abstandskurve zeigt, wo Zeit verloren geht: steigt sie, geht Zeit verloren. Titel antippen zeigt Geschwindigkeit, Bremsen oder Kurven.',
    tour_map: 'Auf der Karte ist die schnellste Runde rot gefärbt, wo die andere verliert, und grün, wo sie gewinnt.',

...
const dict = {
  en: {
    ...
    tour_suggest: '“Suggest comparison” picks the best lap, the laps holding a best sector and a typical lap – the selection lights up in the lap colours.',
    tour_play: 'Analyze: the selected laps run synchronized. Play moves the cursor along the reference lap; videos, charts and map follow.',
    tour_chart: 'Charts compare channels over distance or time – speed, g-forces, GPS deviation, engine data and, with the app, your heart rate. Tap the title to change the channel, pinch to zoom, drag to move the cursor.',
    tour_map: 'The track map shows all laps with the cursor position, sectors and corner numbers – as street map or satellite image.',
    ...
    tour_video: 'Video player with data overlay – speed and lap time from the recorded data, frame-accurate to the cursor.',
    tour_device: 'Race Navigator: the RN Analyzer app from the App Store or Google Play connects to the device in its WiFi, controls recording, driver and car, imports laps with their videos – and on iPhone adds your heart rate from Apple Health as a channel.',
    ...
    ch_hr: 'Heart rate', health_load: 'Load heart rate from Apple Health', health_loading: 'Reading Apple Health…', health_loaded: 'Heart rate added ({n} samples) – channel “Heart rate” in the analyzer', health_none: 'No heart rate in Apple Health for this lap. Was a watch recording?', health_failed: 'Apple Health: {e}',
    ...
    native_required_text: 'Connecting to the Race Navigator – downloading laps and videos over WiFi, controlling the device, and adding your heart rate from Apple Health – needs the RN Analyzer app from the App Store or Google Play. This web version works with .rnz and .mp4 files you import yourself.',
  ...
  de: {
    ...
    tour_suggest: '„Vergleich vorschlagen“ wählt die beste Runde, die Runden mit einem besten Sektor und eine typische Runde – die Auswahl leuchtet in den Rundenfarben.',
    tour_play: 'Analyse: Die gewählten Runden laufen synchron. Play bewegt den Cursor entlang der Referenzrunde; Videos, Diagramme und Karte folgen.',
    tour_chart: 'Diagramme vergleichen Kanäle über Distanz oder Zeit – Geschwindigkeit, G-Kräfte, GPS-Abweichung, Motordaten und mit der App auch den Puls. Titel antippen wechselt den Kanal, Zwei-Finger-Zoom, Ziehen bewegt den Cursor.',
    tour_map: 'Die Streckenkarte zeigt alle Runden mit Cursorposition, Sektoren und Kurvennummern – als Straßenkarte oder Satellitenbild.',
    ...
    tour_video: 'Videoplayer mit Datenoverlay – Geschwindigkeit und Rundenzeit aus den Messdaten, bildgenau zum Cursor.',
    tour_device: 'Race Navigator: Die RN Analyzer App aus dem App Store oder von Google Play verbindet sich mit dem Gerät im WLAN, steuert Aufnahme, Fahrer und Fahrzeug, importiert Runden samt Videos – und ergänzt auf dem iPhone den Puls aus Apple Health als Kanal.',
    ...
    ch_hr: 'Herzfrequenz', health_load: 'Puls aus Apple Health laden', health_loading: 'Apple Health wird gelesen …', health_loaded: 'Puls übernommen ({n} Messwerte) – Kanal „Herzfrequenz“ im Analyzer', health_none: 'Kein Puls in Apple Health für diese Runde. Hat eine Uhr aufgezeichnet?', health_failed: 'Apple Health: {e}',
    ...
    native_required_text: 'Die Verbindung zum Race Navigator – Runden und Videos per WLAN laden, das Gerät steuern und den Puls aus Apple Health ergänzen – gibt es in der RN Analyzer App aus dem App Store oder von Google Play. Diese Web-Version arbeitet mit .rnz- und .mp4-Dateien, die du selbst importierst.',

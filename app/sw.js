...
const VERSION = 'rn-analyzer-v2.0.38';
...
const ASSETS = [
  ...
  './js/import.js', './js/chart.js', './js/map.js', './js/device.js', './js/deviceNative.js', './js/update.js', './js/tabbar.js', './js/coach.js', './js/ai.js', './js/tour.js', './js/weather.js', './js/health.js', './js/reference.js', './demo/index.json', './demo/demo-lap6.rnz', './demo/demo-lap13.rnz', './demo/demo-lap62.rnz', './js/deviceControl.js', './js/sync.js', './js/xlsx.js', './js/share.js',
  './js/views/laps.js', './js/views/analyzer.js', './js/views/device.js', './js/views/devices.js', './js/views/control.js', './js/views/settings.js',

...
const VERSION = 'rn-analyzer-v2.0.17';
...
const ASSETS = [
  ...
  './js/import.js', './js/chart.js', './js/map.js', './js/device.js', './js/deviceNative.js', './js/update.js', './js/deviceControl.js', './js/sync.js', './js/xlsx.js', './js/share.js',

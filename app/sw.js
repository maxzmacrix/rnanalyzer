...
const VERSION = 'rn-analyzer-v2.0.36';
...
const ASSETS = [
  ...
  './js/import.js', './js/chart.js', './js/map.js', './js/device.js', './js/deviceNative.js', './js/update.js', './js/tabbar.js', './js/tour.js', './js/weather.js', './js/health.js', './demo/index.json', './demo/demo-lap6.rnz', './demo/demo-lap13.rnz', './demo/demo-lap62.rnz', './js/deviceControl.js', './js/sync.js', './js/xlsx.js', './js/share.js',
